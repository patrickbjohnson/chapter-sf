...
class DesktopMenu extends Component {
    ...
    navClasses = (nav) => {
        return this.state.activeNav === nav ? `${styles.active} ${styles.link}` : styles.link
    }

    logoClasses = () => {
        return this.state.showLogo ? `${styles.isVisible} ${styles.logo}` : styles.logo
    }

    mobileIconClasses = () => {
        return this.state.mobileMenu ? `${styles.mobileMenu} ${styles.open}` : styles.mobileMenu
    }

        ...
        <section className={styles.section} data-hero>
            ...
            <Slider {...slideSettings} >
                {slides.map((slide, i) => {
                    return (
                        <div key={i}>
                            <div className={styles.slide} style={{backgroundImage: `url(${slide.img})`}}>
                                <h2>{slide.text}</h2>
                                <div className={styles.caption}>
                                    {(slide.credit && slide.url) &&
                                        <a className={styles.credit} href={slide.url}>{slide.credit}</a>
                                    }

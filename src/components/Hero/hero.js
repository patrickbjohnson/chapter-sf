    ...
    return (
        <section className={styles.section} data-hero>
            <div className={styles.content}>
                ...
                <h2 className={styles.copy}>Chapter is a new type of <span>creative studio</span> focused on <spn>designing soulful brands</spn> that thrive in today's world of unreasonable expectations.</h2>
            </div>

...
const siteContent = {
    ...
    "bios": [
        ...
        },
        {
            "name": "Neil Robinson",
            "title": "Founding Partner",
            "desc": "Ex-ECD AKQA San Francisco. After helping to build one of the best agencies in the world for 17 years hit the reset button to build something from the ground up that's designed to do the right thing.",
            "linkedin:": "neilrobinson",
            "twitter": "dnrobinson",
